...
__decorate([
    swagger_1.ApiOkResponse({ description: 'Returns jwt tokens' }),
    swagger_1.ApiInternalServerErrorResponse({ description: '500. InternalServerError' }),
...
__decorate([
    swagger_1.ApiOkResponse({ description: '200, Success' }),
    swagger_1.ApiInternalServerErrorResponse({ description: '500. InternalServerError' }),
...
__decorate([
    swagger_1.ApiOkResponse({ description: '200, returns new jwt tokens' }),
    swagger_1.ApiUnauthorizedResponse({ description: '401. Token has been expired' }),
    swagger_1.ApiInternalServerErrorResponse({ description: '500. InternalServerError ' }),
